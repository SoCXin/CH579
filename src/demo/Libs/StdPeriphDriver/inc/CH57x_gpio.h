...
#define	GPIOA_ReadITFlagPort()			(R16_PA_INT_IF)				/* GPIOA端口中断标志状态 */
#define	GPIOB_ReadITFlagPort()			(R16_PB_INT_IF)				/* GPIOB端口中断标志状态 */
#define	GPIOA_ReadITFlagBit( pin )		(R16_PA_INT_IF&pin)		    /* GPIOA端口引脚中断标志状态 */
#define	GPIOB_ReadITFlagBit( pin )		(R16_PB_INT_IF&pin)		    /* GPIOB端口引脚中断标志状态 */
#define	GPIOA_ClearITFlagBit( pin )		(R16_PA_INT_IF = pin)		/* GPIOA端口引脚中断标志状态 */
#define	GPIOB_ClearITFlagBit( pin )		(R16_PB_INT_IF = pin)		/* GPIOB端口引脚中断标志状态 */
