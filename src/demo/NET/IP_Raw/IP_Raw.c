...
/* CH579相关定义 */
UINT8 MACAddr[6] = {0x84,0xc2,0xe4,0x02,0x03,0x05};                             /* CH579MAC地址 */
...
UINT8 test_string[]={
    ...
    0x73,0x74,0x75,0x76,0x77,0x61,0x62,0x63,0x64,
    0x65,0x66,0x67,0x68,0x69};                                                  /*测试用的IP 报文*/
...
/*******************************************************************************
* Function Name  : CH57xNET_CreatTIPRAWSocket
* Description    : 创建IPRAW socket
* Input          : None
* Output         : None
* Return         : None
*******************************************************************************/
void CH57xNET_CreatIPRAWSocket(void)
{
   ...
   CH57xNET_SocketCreat(&SocketId,&TmpSocketInf);                               /* 创建socket，将返回的socket索引保存在SocketId中 */
}
