...
{
	uint8_t i;
    uint8_t *macaddr=(PUINT8)(ROM_MAC_ADDR+5);
...
{
	R32_ETH_MIWR = (reg_add & RB_ETH_MIREGADR_MIRDL) ;
	return R16_ETH_MIRD;
}
...
void ETH_Configuration( uint8_t *macAddr )
{
    ...
    R8_ETH_ESTAT |= RB_ETH_ESTAT_INT | RB_ETH_ESTAT_BUFER;              //clear status
