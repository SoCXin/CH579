...
#define SYS_SLIST_CONTAINER_TYPE(__ln, __cn, __ty, __n)    \
        ((__ln) ? CONTAINER_OF((__ln), __ty, __n) : NULL)
/*
...
#define SYS_SLIST_PEEK_HEAD_CONTAINER_TYPE(__sl, __cn, __ty, __n)  \
        SYS_SLIST_CONTAINER_TYPE(sys_slist_peek_head(__sl), __cn, __ty, __n)
...
#define SYS_SLIST_PEEK_NEXT_CONTAINER_TYPE(__cn, __ty, __n)                            \
        ((__cn) ? SYS_SLIST_CONTAINER_TYPE(sys_slist_peek_next(&((__cn)->__n)),  \
                __cn, __ty, __n) : NULL)
...
#define SYS_SLIST_FOR_EACH_CONTAINER_TYPE(__sl, __cn, __ty, __n)                   \
    for (__cn = SYS_SLIST_PEEK_HEAD_CONTAINER_TYPE(__sl, __cn, __ty, __n); __cn;   \
         __cn = SYS_SLIST_PEEK_NEXT_CONTAINER_TYPE(__cn, __ty, __n))
