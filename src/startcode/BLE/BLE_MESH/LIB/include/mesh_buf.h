 ...
 */
extern void *net_buf_simple_add(struct net_buf_simple *buf, size_t len);
 ...
 * @return The original tail of the buffer.
 */
extern void *net_buf_simple_add_mem(struct net_buf_simple *buf, const void *mem, size_t len);
 ...
 */
extern u8_t *net_buf_simple_add_u8(struct net_buf_simple *buf, u8_t val);
 ...
 */
extern void net_buf_simple_add_le16(struct net_buf_simple *buf, u16_t val);
 ...
 * @param val 16-bit value to be added.
 */
extern void net_buf_simple_add_be16(struct net_buf_simple *buf, u16_t val);
 ...
 */
extern void net_buf_simple_add_le32(struct net_buf_simple *buf, u32_t val);
 ...
 * @param val 32-bit value to be added.
 */
extern void net_buf_simple_add_be32(struct net_buf_simple *buf, u32_t val);
 ...
 */
extern void *net_buf_simple_push(struct net_buf_simple *buf, size_t len);
 ...
 */
extern void net_buf_simple_push_le16(struct net_buf_simple *buf, u16_t val);
 ...
 * @param val 16-bit value to be pushed to the buffer.
 */
extern void net_buf_simple_push_be16(struct net_buf_simple *buf, u16_t val);
 ...
 */
extern void net_buf_simple_push_u8(struct net_buf_simple *buf, u8_t val);
 ...
 */
extern void *net_buf_simple_pull(struct net_buf_simple *buf, size_t len);
 ...
 */
extern void *net_buf_simple_pull_mem(struct net_buf_simple *buf, size_t len);
 ...
 */
extern u8_t net_buf_simple_pull_u8(struct net_buf_simple *buf);
 ...
 */
extern u16_t net_buf_simple_pull_le16(struct net_buf_simple *buf);
 ...
 */
extern u16_t net_buf_simple_pull_be16(struct net_buf_simple *buf);
 ...
 */
extern u32_t net_buf_simple_pull_le32(struct net_buf_simple *buf);
 ...
 */
extern u32_t net_buf_simple_pull_be32(struct net_buf_simple *buf);
 ...
 */
extern size_t net_buf_simple_headroom(struct net_buf_simple *buf);
 ...
 */
extern size_t net_buf_simple_tailroom(struct net_buf_simple *buf);
 ...
 */
extern void net_buf_simple_reserve(struct net_buf_simple *buf, size_t reserve);
...
#define NET_BUF_POOL_HEAP_DEFINE_UN(_name, _count, _destroy)            \
...
#define net_buf_alloc_fixed(_pool, _timeout) \
    net_buf_alloc_fixed_debug(_pool, _timeout, __FUNCTION__, __LINE__)
#else
...
#define net_buf_unref(_buf) \
        net_buf_unref_debug(_buf, __FUNCTION__, __LINE__)
#else
